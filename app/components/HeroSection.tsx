...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-24 pb-6 sm:pt-32 sm:pb-10 lg:pt-36 lg:pb-12 overflow-hidden section-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col text-right">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full glass-card border border-amber-500/40 text-amber-600 dark:text-amber-300 text-xs sm:text-sm font-serif font-semibold w-fit mb-5 shadow-xl shadow-amber-500/5 hover:border-amber-400/50 transition-colors">
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-500 animate-spin-slow shrink-0" />
              <span className="truncate">تطبيق يُسْر (Yusr) • «الدَّالُّ على الخيرِ كفاعلِه»</span>
            </div>

            {/* Main Headline with High-Contrast Logo Badge */}
            <div className="flex items-center gap-3 sm:gap-4 mb-4">
              <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-white logo-badge-container p-1 sm:p-1.5 flex items-center justify-center shadow-2xl shrink-0">
                <Image
                  src={yusrLogo}
                  alt="شعار يُسْر"
                  width={75}
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black leading-[1.15] tracking-tight text-themed-heading">
                تطبيق <span className="text-gradient-emerald font-serif">يُسْر — Yusr</span>
              </h1>
            </div>

            {/* Subtitle / Slogan */}
            <p className="text-xl sm:text-3xl text-amber-600 dark:text-amber-300 font-serif font-bold mb-4 sm:mb-6 leading-snug">
              رفيقك اليومي في القرآن والأذكار ومواقيت الصلاة 🌙
            </p>

            {/* Description */}
            <p className="text-sm sm:text-lg opacity-90 font-normal leading-relaxed mb-6 sm:mb-8 max-w-2xl text-themed-sub">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mb-8 sm:mb-10 text-xs sm:text-sm font-semibold">
              <div className="flex items-center justify-center gap-2 glass-card px-3 py-2.5 sm:py-3 rounded-2xl border border-emerald-500/20 text-themed-sub">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4" id="download">
              {/* iOS Button */}
              <a
                href={iosUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 hover:bg-white/20 dark:bg-white/10 dark:hover:bg-white/20 text-themed-heading font-bold px-6 py-3.5 sm:px-7 sm:py-4 rounded-2xl border border-themed-strong hover:border-amber-400/60 shadow-xl shadow-amber-500/5 hover:scale-105 transition-all duration-300 flex items-center justify-center sm:justify-start gap-3 text-sm sm:text-base"
              >
                <Apple className="w-5 h-5 sm:w-6 sm:h-6 text-amber-500 dark:text-amber-400 shrink-0" />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-emerald hover:brightness-110 text-white font-bold px-6 py-3.5 sm:px-7 sm:py-4 rounded-2xl shadow-xl shadow-emerald-600/30 hover:shadow-emerald-500/50 hover:scale-105 transition-all duration-300 flex items-center justify-center sm:justify-start gap-3 text-sm sm:text-base"
              >
              ...
              <a
                href="#feature-videos"
                className="glass-card hover:bg-emerald-500/15 text-themed-sub font-semibold px-5 py-3.5 sm:py-4 rounded-2xl border border-emerald-500/30 transition-all flex items-center justify-center gap-2 text-sm"
              >
            ...
            {/* Trust Metrics Bar */}
            <div className="flex flex-wrap items-center justify-between sm:justify-start gap-4 sm:gap-6 mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-themed">
              <div>
              ...
              <div>
                <p className="text-base sm:text-lg font-bold text-themed-heading">40+ ميزة</p>
                <p className="text-xs text-themed-muted">إيمانية وفقهية</p>
              </div>
              <div className="hidden sm:block h-8 w-px bg-[var(--border-color)]" />
              <div>
                <p className="text-base sm:text-lg font-bold text-themed-heading">100%</p>
          ...
          <div className="lg:col-span-6 relative flex justify-center items-center py-4 sm:py-6 overflow-hidden max-w-full">
            ...
            <div className="relative w-full max-w-[280px] xs:max-w-xs sm:max-w-lg h-[340px] xs:h-[420px] sm:h-[540px] flex items-center justify-center">
              ...
              <div className="absolute z-20 w-36 xs:w-40 sm:w-60 aspect-[9/19] rounded-[22px] xs:rounded-[26px] sm:rounded-[38px] shadow-2xl shadow-emerald-950/40 transform hover:scale-105 transition-all duration-500 overflow-hidden">
                <Image
                  src={yusrAppHome}
              ...
              <div className="absolute -right-1 xs:right-0 sm:right-2 top-4 sm:top-8 w-32 xs:w-36 sm:w-56 aspect-[9/19] rounded-[20px] xs:rounded-[24px] sm:rounded-[36px] shadow-2xl transform rotate-6 hover:rotate-0 hover:z-30 hover:scale-105 transition-all duration-500 z-10 overflow-hidden">
                <Image
                  src={yusrAppTafseer}
